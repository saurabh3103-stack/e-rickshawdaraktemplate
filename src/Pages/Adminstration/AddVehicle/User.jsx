...
<button type="button" className="btn btn-sm btn-warning me-1" onClick={() => handleUpdate(row._id,row)}>
  ...
  <div class="content-wrapper">
        ...
        <div class="card">
          <div class="card-header bg-primary text-white" style={{ padding: '.5rem 1rem' }}>
            <div class="row">
              <div class="col-6">
                <h5
              ...
              <div class="col-6">
                <Link to={'/add_user'} class="btn btn-success" style={{float:"inline-end"}}>
                  Add Vehicle
                </Link>
              </div>
            </div>
