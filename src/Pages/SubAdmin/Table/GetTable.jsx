...
const GetTable = ({ data = [], columns, title }) => {
  ...
  // Check if data is an array and filter it
      ...
      <DataTable
        ...
        subHeaderComponent={
          <div className="row w-100">
            ...
            <div className='col-md-2 col-lg-2 col-sm-11 col-11'>
              <input type="text" placeholder="Search here" className="form-control bg-light" value={searchedData} onChange={(e) => setSearchedData(e.target.value)} />
            </div>
          </div>
        }
      />
