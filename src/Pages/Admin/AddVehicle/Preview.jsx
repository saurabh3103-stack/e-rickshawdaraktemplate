...
function Preview() {
  ...
  const handleClosePopup = () => {
    ...
    navigate('/admin/users'); // Navigate to the dashboard
  };
  const updateStatus = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.put(
        `https://backend-wheat-gamma.vercel.app/api/users/update_status/${userId}`,
      );
      ...
      <div className="dashboard-main-body">
        <div>
          <div>
            <Brandcrump
              pageName="Dashboard"
              title="Preview E-Rickshaw Details"
              url="/dashboard"
                      ...
                      <div className="card-body">
                          ...
                          <div className="col-lg-3 col-sm-4 col-12">
                            <div className="mb-3">
                              ...
                              <input
                                type="text"
                                className="form-control"
                                value={userData.d_addhar_number}
                                disabled
                                id="d_addhar_number"
                                placeholder="Enter Addhar Card Number"
                              />
                          ...
                          <div className="col-lg-3 col-sm-4 col-12">
                            <div className="mb-3">
                              ...
                              <input
                                type="text"
                                className="form-control"
                                value={userData.d_address_line_f}
                                disabled
                                id="d_address_line_f"
                                placeholder="Enter Address Line 1"
                              />
                          ...
                          <div className="col-lg-3 col-sm-4 col-12">
                            <div className="mb-3">
                              ...
                              <input
                                ...
                                disabled
                                id="d_address_line_t"
                                value={userData.d_address_line_t}
                                placeholder="Enter Address Line 2"
                              />
                            </div>
                          </div>
                        ...
                        <div className="row gx-3">
                          <div className="col-lg col-sm-4 col-12">
                            ...
                            <img
                              src={imageUrl + userData.owner_photo}
                              class="img-fluid"
                            />
                          </div>
                          <div className="col-lg col-sm-4 col-12">
                            ...
                            <img
                              src={imageUrl + userData.addhar_image}
                              class="img-fluid"
                            />
                          </div>
                          <div className="col-lg col-sm-4 col-12">
                            ...
                            <img
                              src={imageUrl + userData.owner_dl_image}
                              class="img-fluid"
                            />
                          </div>
                          <div className="col-lg col-sm-4 col-12">
                            ...
                            <img
                              src={imageUrl + userData.rickshaw_photo}
                              class="img-fluid"
                            />
                          </div>
                          <div className="col-lg col-sm-4 col-12">
                          ...
                          <div className="col-lg col-sm-4 col-12">
                            ...
                            <img
                              src={imageUrl + userData.d_addhar_image}
                              class="img-fluid"
                            />
                          </div>
                          <div className="col-lg col-sm-4 col-12">
                            ...
                            <img
                              src={imageUrl + userData.driver_dl_image}
                              class="img-fluid"
                            />
                          </div>
                        </div>
